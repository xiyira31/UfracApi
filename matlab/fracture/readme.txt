Packaging and Deploying FraSimMulCNforPython
...
2. Installing the FraSimMulCNforPython Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   FraSimMulCNforPython. If you do not have write permissions, copy all its contents to a 
...
3. Using the FraSimMulCNforPython Package

The FraSimMulCNforPython package is on your Python path. To import it into a Python 
