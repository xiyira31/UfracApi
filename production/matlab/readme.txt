Packaging and Deploying Simple_Fracture_function_python
...
2. Installing the Simple_Fracture_function_python Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   Simple_Fracture_function_python. If you do not have write permissions, copy all its 
...
3. Using the Simple_Fracture_function_python Package

The Simple_Fracture_function_python package is on your Python path. To import it into a 
   Python script or session, simply execute:
